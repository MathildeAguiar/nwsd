...
BERT_PATH=$BASE_PATH/pt_models/flaubert_large_cased
...
TARGET_DIRECTORY=$BASE_PATH/trained_models/flaubert_large_no_sense_comp # to store the trained model
TXT_TO_WSD=$BASE_PATH/data/to_disambiguate
WEIGHTS_PATH=$BASE_PATH/trained_models/flaubert_large_no_sense_comp/model_weights_wsd0
