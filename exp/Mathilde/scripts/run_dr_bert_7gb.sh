...
#SBATCH --job-name=drbert_7gb_no_sense_comp
...
#SBATCH --output=drbert_7gb_no_sense_comp
...
BERT_PATH=$BASE_PATH/pt_models/DrBERT-7GB
...
TARGET_DIRECTORY=$BASE_PATH/trained_models/drbert_7gb_no_sense_comp # to store the trained model
TXT_TO_WSD=$BASE_PATH/data/to_disambiguate
WEIGHTS_PATH=$BASE_PATH/trained_models/drbert_7gb_no_sense_comp/model_weights_wsd0
