...
#SBATCH --job-name=biobert_no_sense_comp
...
#SBATCH --output=biobert_no_sense_comp
...
BERT_PATH=$BASE_PATH/pt_models/biobert-v1.1
...
TARGET_DIRECTORY=$BASE_PATH/trained_models/biobert_no_sense_comp # to store the trained model
TXT_TO_WSD=$BASE_PATH/data/to_disambiguate
WEIGHTS_PATH=$BASE_PATH/trained_models/biobert_no_sense_comp/model_weights_wsd0
