...
#SBATCH --job-name=pubmedbert_no_sense_comp
...
#SBATCH --output=pubmedbert_no_sense_comp
...
BERT_PATH=$BASE_PATH/pt_models/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext
...
TARGET_DIRECTORY=$BASE_PATH/trained_models/pubmedbert_no_sense_comp # to store the trained model
TXT_TO_WSD=$BASE_PATH/data/to_disambiguate
WEIGHTS_PATH=$BASE_PATH/trained_models/pubmedbert_no_sense_comp/model_weights_wsd0
